...
- Matches are grouped under sticky day headers and sorted chronologically.
- Filters: **All / Groups / Knockouts**, plus a **Favorites-only** toggle.
...
lib     → pure logic: datetime, record, standings, bracket, advancement, rng, model
...
**Done:** all four core features, favorites/reminders, PWA, dark mode, unit
tests, both data sources.
